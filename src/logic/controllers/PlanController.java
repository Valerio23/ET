...
public class PlanController {
	...
	private int setPrice(String price) {
		...
		if (price.equalsIgnoreCase("€ 100 - € 150"))
			return 2;
		
		if (price.equalsIgnoreCase("€ 150 - € 225"))
			return 3;
		
		if (price.equalsIgnoreCase("More than € 225"))
			return 4;
	...
	private PrivateTravel viaggioBeanToViaggio(PrivateTravelBean vg) {
		...
		hotel.setBreakfast(vg.getHotelInfo().getBreakfast());
		hotel.setHotelLink(vg.getHotelInfo().getHotelLink());
		hotel.setHotelName(vg.getHotelInfo().getHotelName());
		hotel.setNumRooms(Integer.valueOf(vg.getHotelInfo().getNumRooms()));
		hotel.setPrice(vg.getHotelInfo().getPrice());
		hotel.setStars(Integer.valueOf(vg.getHotelInfo().getStars()));
	...
	private PublicTravel viaggioGruppoBeanToViaggioGruppo(PublicTravelBean vg) {
		...
		viaggioGruppo.setHotelInfo(hotel);
