...
public class PlanControllerView implements Initializable {
    ...
    private void radioPublicTravelSelected() { 	
		...
		viaggioGruppoBean.getHotelInfo().setPrice(cbPrice.getSelectionModel().getSelectedItem());
    ...
    private void radioPrivateTravelSelected() {
		...
		viaggioBean.getHotelInfo().setPrice(cbPrice.getSelectionModel().getSelectedItem());
	...
	public void setPrivateTravelInfo(PrivateTravelBean vgBean) {
		...
		cbPrice.setValue(this.vgBean.getHotelInfo().getPrice());
