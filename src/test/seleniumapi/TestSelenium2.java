...
public class TestSelenium2 {
	...
	public static void main(String[] args) {
		...
		String username = "Ibra99";
		String email = "ibra99@gmail.com";
		String password = "IbraSupremacy99.";
		String actualUsername = "";
		String actualEmail = "";
		Boolean ret = false;
		
		driver.get("http://localhost:8080/EasyTravel/signup.jsp");
		driver.findElement(By.xpath("//*[@id=\"contact_form\"]/div[2]/div/div/input")).sendKeys("Zlatan");
		driver.findElement(By.xpath("//*[@id=\"contact_form\"]/div[3]/div/div/input")).sendKeys("Ibrahimovic");
